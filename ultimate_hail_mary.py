"""
Ultimate Safe Hail Mary
=======================
1. Bypasses the PyArrow SO3_T bug.
2. Assumes native row order is chronological within CV_GROUP.
3. 5-Fold, fast learning.
"""
...
# Exclude SO3_T to avoid PyArrow crash
...
test_meta = pd.read_parquet("test.parquet", columns=["ID", "CV_GROUP"])
...
# Smooth purely over native row order inside group, which is strictly chronological
