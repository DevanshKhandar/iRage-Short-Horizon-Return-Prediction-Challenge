"""
Final Hail Mary Submission Pipeline
===================================
...
TOP_N = 180 # Increased features to 180
...
for cfg in CONFIGS:
    ...
    for fi, (tr, va) in enumerate(gkf.split(X_train, y_clip, groups)):
        ...
        # Using 5000 rounds with early stopping
        bst = lgb.train(cfg["params"], dt, 5000, valid_sets=[dv], valid_names=["v"],
